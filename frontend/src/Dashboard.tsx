...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="no-print bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between shadow-sm">
        <div>
      ...
      <main className="flex flex-1 overflow-hidden">
        <aside className="no-print w-[22rem] min-w-[20rem] border-r border-slate-200 bg-white overflow-y-auto p-4 space-y-3 flex-shrink-0">
          <RegionSelector />
