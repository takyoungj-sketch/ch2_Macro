...
export const STATS_GLOSSARY: Record<string, StatsGlossaryEntry> = {
  ...
  floor_utility_index: {
    ...
    title: "층·동·면적 효용지수",
    definition:
      "같은 단지(또는 도로 cluster) 안 집합 실거래에서, 기준 층·동·면적 대비 단가가 얼마나 다른지를 %로 본 값입니다. 국토부 집합 실거래, 선택한 롤링 창입니다.",
    interpretation: [
      "100이 기준입니다. 120이면 기준보다 단가가 약 20% 높았다는 뜻입니다.",
      "주거는 단지(건물), 비주거는 도로명 cluster가 분석 단위입니다.",
    ],
    limitations: ["표본이 적으면 층·동이 흔들립니다.", "다른 단지·다른 도로와 숫자를 바로 비교하지 마세요."],
  },
  commercial_cluster: {
