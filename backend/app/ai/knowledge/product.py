...
""",
    "insight": """
Macro Insight:
- 공개 FAQ. 1번 전국 월(금리·M2와 거래), 2번 시군구 유형 규모·단가, 3번 연립·다세대 건물 안 층×승강기, 4번 토지 칸 안 면적×㎡당 가격.
- 1·2번 숫자는 공개 /api/insight/01·02. 3·4번은 고정 스냅샷(copy). 랩 API를 부르지 않음.
- 상관계수 r·퍼센트는 표의 칸. 문장에 없는 숫자를 만들지 않음. 3번의 13.5와 26을 더하지 않음. 4번의 약 −20%를 전국 할인율·회귀 계수로 쓰지 않음.
