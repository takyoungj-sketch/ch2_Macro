...
export const BUILT_RECOMMEND_HELP: AnalysisExplain = {
  ...
  title: "Macro 모형 탐색",
  summary:
    "① CV-MAPE로 대표 예측모형을 고르고 → ② 그 식을 이 지역 거래의 Local 기준선으로 두고 → ③ Twin1은 같은 식에 쌍둥이 1위만 보태며 → ④ Twin2는 그 표본에서 식을 다시 고르고 → ⑤ Local · Twin1 · Twin2 숫자를 나란히 봅니다. 기본 통계 식은 바꾸지 않습니다.",
  interpretation: [
    ...
    "「중위 오차」가 CV-MAPE보다 훨씬 낮으면 평균을 몇몇 거래가 끌고 있다는 뜻입니다. 그때는 대다수 거래에서의 오차는 중위값에 가깝습니다.",
